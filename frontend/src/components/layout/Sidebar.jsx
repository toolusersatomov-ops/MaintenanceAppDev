...
const MENUS = {
  ...
  operations_staff: [
    ...
    { label: "Machine Bin Status", path: "/operations/bins", icon: Warehouse },
  ...
  operations_supervisor: [
    ...
    { label: "Cleaning & Sanitization Tracking", path: "/supervisor/cleaning-tracking", icon: Sparkles },
  ...
  maintenance_technician: [
    ...
    { label: "My Machines", path: "/technician/my-machines", icon: Boxes },
    ...
    { label: "Component Testing", path: "/technician/component-testing", icon: Cog },
    { label: "Parts Replacement", path: "/technician/parts-replacement", icon: PackageSearch },
    { label: "Spare Parts", path: "/technician/spare-parts", icon: PackagePlus },
    { label: "Door / Panel Access", path: "/technician/door-panel-access", icon: DoorOpen },
    { label: "Service History", path: "/technician/service-history", icon: History },
  ...
  maintenance_supervisor: [
    ...
    { label: "Live Maintenance Progress", path: "/maintenance-supervisor/live-progress", icon: Activity },
    { label: "Preventive Maintenance Planner", path: "/maintenance-supervisor/pm-planner", icon: ShieldCheck },
    { label: "Calibration Monitoring", path: "/maintenance-supervisor/calibration-monitoring", icon: Settings },
