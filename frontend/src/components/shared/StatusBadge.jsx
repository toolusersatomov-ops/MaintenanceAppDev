...
const STATUS_STYLES = {
  ...
  "Reached Machine": "bg-blue-100 text-blue-800 border-blue-300",
  "Diagnosis Started": "bg-indigo-100 text-indigo-800 border-indigo-300",
  "Diagnosis Completed": "bg-indigo-100 text-indigo-800 border-indigo-300",
  "Repair In Progress": "bg-amber-100 text-amber-800 border-amber-300",
  "Waiting for Parts": "bg-orange-100 text-orange-800 border-orange-300",
  Testing: "bg-cyan-100 text-cyan-800 border-cyan-300",
  "Pending Supervisor Review": "bg-purple-100 text-purple-800 border-purple-300",
  // Machine technical health
  Healthy: "bg-green-100 text-green-800 border-green-300",
  Down: "bg-red-200 text-red-900 border-red-400",
  "Under Maintenance": "bg-amber-100 text-amber-800 border-amber-300",
  // Diagnostics / calibration / PM
  ...
  "Not Started": "bg-stone-200 text-ink border-stone-400",
  Due: "bg-amber-100 text-amber-800 border-amber-300",
  "Recalibration Required": "bg-orange-100 text-orange-800 border-orange-300",
  ...
  Used: "bg-stone-200 text-ink border-stone-400",
  Escalated: "bg-red-100 text-red-800 border-red-300",
  "Work Order Created": "bg-blue-100 text-blue-800 border-blue-300",
  RUNNING: "bg-cyan-100 text-cyan-800 border-cyan-300",
  COMPLETED: "bg-green-100 text-green-800 border-green-300",
  OFF: "bg-stone-200 text-ink border-stone-400",
