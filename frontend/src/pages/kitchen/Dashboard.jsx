  ...
  return (
    <div data-testid="kitchen-dashboard-page">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <KPICard label="Pending Requests" value={stats.pending} icon={ClipboardList} />
        <KPICard label="In Progress" value={stats.inProgress} icon={ChefHat} accent />
        <KPICard label="Saved / Ready for Pickup" value={stats.ready} icon={PackageCheck} />
        <KPICard label="Bins in Cleaning" value={stats.cleaning} icon={Sparkles} />
      </div>
    </div>
  );
}
